...
public class TokenStoreConfig {
    ...
    public OAuth2AuthorizationService jdbcAuthorizationService(DataSource dataSource, org.springframework.security.oauth2.server.authorization.client.RegisteredClientRepository clients) {
