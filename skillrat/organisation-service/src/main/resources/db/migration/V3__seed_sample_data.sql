...
-- Optional: SELECT statements for visibility when running manually (ignored by Flyway)
-- SELECT 'Seeded groups:', @grp1_uuid, @grp2_uuid;
-- SELECT 'Seeded units:', @unit1_uuid, @unit2_uuid, @unit3_uuid;
