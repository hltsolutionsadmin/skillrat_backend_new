...
public class DepartmentService {
    ...
    public Page<Department> getAllDepartments(@NonNull UUID b2bUnitId, Pageable pageable) {
    ...
    @Transactional(readOnly = true)
    public Page<Department> searchDepartments(@NonNull UUID b2bUnitId, String searchTerm, Pageable pageable) {
        if (!b2bUnitRepository.existsById(b2bUnitId)) {
            throw new IllegalArgumentException("B2B Unit not found with id: " + b2bUnitId);
        }
